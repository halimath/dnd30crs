...
function createPdf(file, enc, cb) {
    ...
    puppeteer.launch()
        ...
        .then(() => page.pdf({
            ...
            footerTemplate: `<span style="font-family: Ubuntu; font-size: 4px; width: 100%; text-align: center;"><a href="https://github.com/halimath/dnd30crs">github.com/halimath/dnd30crs</a> Version ${version}. This work is licensed under a Creative Commons Attribution 4.0 License.</span>`,
            margin: {
                top: 0,
                left: 0,                
                bottom: 0,
